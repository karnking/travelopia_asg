...
if (w > 768) {
    ...
    let state = true
    document.querySelector('.description>p').innerHTML = desc.substring(0, 241) + '...'
    document.querySelector('.description>p').innerHTML += `<a> ${state ? "Show More":"Show Less"}</a>`
    document.querySelector('description>p>a').addEventListener("click",handleClick)
}
const handleClick = () => {
